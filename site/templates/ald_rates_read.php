  ...
  while (($rawdata = fgetcsv($handle, 0, ",")) !== FALSE) {
    ...
    if($row > 2){
      ...
      switch($data[1]){
        ...
        switch($data[0]){
          case 24:
          $insert = "`24_8K_PA_rental_m` = " . $data12 . ", `24_8K_PA_service_nm` = " . $data11;
          break;
          case 36:
          $insert = "`36_8K_PA_rental_m` = " . $data12 . ", `36_8K_PA_service_nm` = " . $data11;
          break;
          case 48:
          $insert = "`48_8K_PA_rental_m` = " . $data12 . ", `48_8K_PA_service_nm` = " . $data11;
          break;
          case 60:
          $insert = "`60_8K_PA_rental_m` = " . $data12 . ", `60_8K_PA_service_nm` = " . $data11;
          break;
          default:
