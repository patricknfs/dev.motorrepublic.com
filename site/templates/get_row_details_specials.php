...
foreach($entries as $entry){
  ...
  $insert = "INSERT INTO `team`.`rates_combined` VALUES ('','" . $entry['cap_id'] . "', '" . $entry['cap_code'] . "', '" . $entry['source'] . "', NOW(), '" . $entry['expired'] . "', '" . (stripos($row['manufacturer'], 'mercedes' ) === FALSE?$row['manufacturer']:"MERCEDES") . "', '" . $entry['model'] . "', '" . $entry['description_1'] . "', '" . $entry['term'] . "', '" . $entry['mileage'] . "', '" . $entry['rental'] . "', '" . $entry['vehicle_list_price'] . "', '" . $entry['vehicle_otr_price'] . "', '" . $entry['p11d_price'] . "', '" . $entry['co2'] . "', '" . $entry['lcv'] . "', 1, '" . $entry['deal_notes'] . "', '" . $entry['upfront'] . "', '" . str_replace(',','',$entry['special_upfront']) . "', '" . $entry['website_deal_notes'] . "')";
  echo $insert;
