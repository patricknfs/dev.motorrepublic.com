    ...
    function format ( rowData ) {
      ...
      $.ajax( {
        ...
        success: function ( json ) {
          var dealnotes = rowData.deal_notes;
          ...
          // for(var i=0;i<json.length;i++){
            childTable = childTable.concat('<tr><td>' + rowData.vehicle_list_price + '</td><td>' + rowData.vehicle_otr_price + '</td><td>' + rowData.p11d_price + '</td><td>' + rowData.CO2 + '</td><td>' + dealnotes + '</td></tr>');
          // }
