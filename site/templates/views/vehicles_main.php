					...
					<div class="cell">
						<a href="/vehicle/<?=$vehicle['cap_id']?>">
							<div class="card">
								...
								<div class="card-section">
									<h6>Business Clients<br /><span class="price">£<?=$bch_rental?></span><small>/m ex VAT</small></h6>
									<h6>Personal Clients<br /><span class="price">£<?=$pch_rental?></span><small>/m inc VAT</small></h6>
