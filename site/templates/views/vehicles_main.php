					...
					<div class="cell">
						<a href="/vehicle/<?=$vehicle['cap_id']?>">
							<div class="card">
								...
								<div class="card-section">
									<h6>Business Clients<br /><span class="price">£<?=$bch_rental?></span><small>/mth excl. VAT</small></h6>
									<h6>Personal Clients<br /><span class="price">£<?=$pch_rental?></span><small>/mth inc. VAT</small></h6>
