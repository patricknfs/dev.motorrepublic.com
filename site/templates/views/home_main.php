			...
			<div class="cell small-12 medium-4">
				<a href="/vehicle/<?=$data['cap_id']?>">
					<div class="card">
						...
						<img src="https://soap.cap.co.uk/images/vehicleimage.aspx?SUBID=173210&HASHCODE=<?=$hashcode?>&DB=<?=$vehicle_type?>&CAPID=<?=$data['cap_id']?>&DATE=2018/09/11&WIDTH=300&IMAGETEXT=&VIEWPOINT=">
						<div class="card-section">
