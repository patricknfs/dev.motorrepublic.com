		...
		<div class="grid-x grid-margin-x">
			<div class="cell small-12 medium-6 grid-margin-y">
				<div class="cell small-12">
					<a href="/car-leasing/?manufacturer=503"><img src="<?=$config->urls->assets?>graphics/bmw_specials_600.png" /></a>
				</div>
				<div class="cell small-12 medium-6">
					<a href="/car-leasing/?manufacturer=1041"><img src="<?=$config->urls->assets?>graphics/mercedes_specials_600.png" /></a>
				</div>
				<div class="cell small-12 medium-6">
					<a href="/car-leasing/?manufacturer=3498"><img src="<?=$config->urls->assets?>graphics/landrover_specials_600.png" /></a>
				</div>
				<div class="cell small-12 medium-6">
