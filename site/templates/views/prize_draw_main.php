...
<form action="https://motorrepublic.us11.list-manage.com/subscribe/post?u=77b83085a473bef18ca626a93&amp;id=528e7c6883" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
...
<div class="mc-field-group">
	<label for="mce-POSTCODE">First part of PostCode  <span class="asterisk">*</span>
</label>
	<input type="text" value="" name="POSTCODE" class="required" id="mce-POSTCODE">
</div>
<div class="mc-field-group">
	<label for="mce-COMPANY">Company (If applicable) </label>
...
<div id="mergeRow-gdpr" class="mergeRow gdpr-mergeRow content__gdprBlock mc-field-group">
    ...
    <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_77b83085a473bef18ca626a93_528e7c6883" tabindex="-1" value=""></div>
    <div class="clear"><input type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="button"></div>
    </div>
</form>
</div>
<script type='text/javascript' src='//s3.amazonaws.com/downloads.mailchimp.com/js/mc-validate.js'></script><script type='text/javascript'>(function($) {window.fnames = new Array(); window.ftypes = new Array();fnames[0]='EMAIL';ftypes[0]='email';fnames[1]='FNAME';ftypes[1]='text';fnames[2]='LNAME';ftypes[2]='text';fnames[3]='POSTCODE';ftypes[3]='text';fnames[4]='COMPANY';ftypes[4]='text';}(jQuery));var $mcj = jQuery.noConflict(true);</script>
