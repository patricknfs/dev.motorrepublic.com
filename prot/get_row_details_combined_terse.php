...
while ($row = mysqli_fetch_assoc($result)) {
  ...
  $vehicle_list  = $row['vehicle_list'] ?? '';
  $insert = "REPLACE INTO `team`.`rates_combined_terse` VALUES ('','" . $row['cap_id'] . "', '" . $row['cap_code'] . "', '" . $row['src'] . "', '" . $row['updated'] . "', '', '" . $row['manufacturer'] . "', '" . $row['model'] . "', '" . $row['descr'] . "', '" . $row['term'] . "', '" . $row['mileage'] . "', '" . $row['rental'] . "', '" . $vehicle_list . "', '" . $row['vehicle_otr'] . "', '" . $row['p11d'] . "', '" . $row['CO2_no'] . "', '" . $row['lcv'] . "', '" . $row['special'] . "', '" . $row['deal_notes'] . "', '" . $row['upfront'] . "', '" . str_replace(',','',$row['special_upfront']) . "', '" . $row['website_deal_notes'] . "')";
  // echo $insert;
